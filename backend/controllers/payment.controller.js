...
// Mock payment initialization (for testing without valid Chapa key)
// TODO: Replace with real Chapa when account is fully activated
export const initializePaymentController = async (req, res) => {
  try {
    ...
    console.log("✅ Mock Payment Initialized:", tx_ref);
  ...
  try {
    ...
    await orderModel.findOneAndUpdate(
      { "payment.tx_ref": tx_ref },
      {
        ...
        "payment.method": "Mock Payment (Test Mode)",
    ...
    console.log("✅ Mock Payment Verified:", tx_ref);
